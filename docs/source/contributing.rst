...
bonked is a community-maintained project and happily accepts contributions.
Thank you for considering contributing. ❤️

Adding Features / Fixing Bugs
-----------------------------

#. `Check for open issues <https://github.com/brl0/bonked/issues>`_ or open
...
#. Fork the `bonked repository on Github <https://github.com/brl0/bonked>`_
